...
const Clients = () => {
  return (
    <section className='py-20 w-screen h-[50vw] pb-50 relative'>
        <div className='w-full h-full flex items-center justify-center'>
            ...
            <div className='absolute top-20 left-30 blur-xs'>
                <Image src="/assets/images/manipal.png" height={145} width={276} alt='manipal'/>
            </div>
            <div className='absolute top-0 right-200 blur-xs'>
            ...
            <div className='absolute bottom-30 right-200 blur-sm'>
