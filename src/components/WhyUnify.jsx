...
const WhyUnify = () => {
    ...
    return (
        <section className='h-full w-screen relative pb-[15vw] mt-[-150vw] pt-[35vw] ' ref={sectionRef} >
            <div className='absolute top-0 left-0 h-full w-screen bg-gradient-to-r from-[#F16B0D] to-[#E61216]'>
                ...
                <div className='space-y-15' >
                    ...
                    <div className='w-full flex items-center justify-between '>
                        <div className='flex w-[15%] gap-5'>
                            <div>
                                <Image src="/assets/icons/whychoose-navigation.svg" height={518} width={20} alt='navigation'/>
                            </div>
                        ...
                        <div className='w-[30%] flex flex-col gap-[1.5vw]'>
                            <div className='rounded-2xl overflow-hidden h-fit w-fit'>
                                <Image src="/assets/images/homepage/whyunify-img-1.png" height={390} width={382} className='h-[14vw] w-[16vw] object-cover '/>
                            </div>
                            <div className='rounded-2xl overflow-hidden h-fit w-fit ml-[7vw]'>
                                <Image src="/assets/images/unify-dashboard-2.png" height={247} width={283}  className='h-[13vw] w-[15vw] object-cover '/>
                            </div>
                        </div>
                        <div className='space-y-10 w-[44%]' ref={textRef}>
                            <p className='text-[2.6vw] text-white overflow-hidden font-light '>End-to-End AI Lifecycle Management – From Model Training to Production Deployment</p>
