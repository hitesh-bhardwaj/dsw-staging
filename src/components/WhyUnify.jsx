                ...
                <div className='space-y-25'>
                    ...
                    <div className='w-full flex items-center justify-between '>
                        <div className='flex w-[20%] gap-5'>
                            ...
                            <div className=' text-[#111111] space-y-13 content-p'>
                        ...
                        <div className='space-y-10 w-[44%]'>
                            ...
                            <p className='text-[#111111] content-p w-[88%]'>UnifyAI provides a complete AI development ecosystem, allowing businesses to build, test, optimize, and deploy AI/ML models seamlessly. From data ingestion and preprocessing to model training, evaluation, and real-time inference, UnifyAI ensures a streamlined workflow, reducing time-to-market and eliminating inefficiencies.</p>
                          <WhiteButton text={"Know More"} href={"#"}/>
                        </div>
